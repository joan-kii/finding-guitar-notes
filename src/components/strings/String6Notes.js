...
const String6Notes = () => {
  ...
  const { string6Exercise, setString6Exercise, setActualExercise, currentUser } = useContext(Context);
  ...
  }, [rightNotes, setString6Exercise, currentUser]);
  ...
  return (
    <div>
      ...
      <Backdrop 
        ...
        open={!string6Exercise} 
        close={string6Exercise} >
        <CircularProgress 
          color='inherit'
          thickness='6' />
      </Backdrop>
